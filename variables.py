...
aa_layout = [
    ...
    [sg.Text("Select Glutamine"), sg.DropDown(decorative_blocks, key="GLN", default_value="pink_stained_glass")],
    [sg.Text("Select Glycine"), sg.DropDown(decorative_blocks, key="GLU", default_value="lime_stained_glass")],
    [sg.Text("Select Histidine"), sg.DropDown(decorative_blocks, key="GLY", default_value="green_stained_glass")],
    [sg.Text("Select Isoleucine"), sg.DropDown(decorative_blocks, key="HIS", default_value="light_blue_stained_glass")],
    [sg.Text("Select Leucine"), sg.DropDown(decorative_blocks, key="ILE", default_value="cyan_stained_glass")],
